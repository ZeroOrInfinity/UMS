...
public class EnhanceConcurrentControlAuthenticationStrategy extends ConcurrentSessionControlAuthenticationStrategy implements ApplicationEventPublisherAware {
     ...
     */
    public EnhanceConcurrentControlAuthenticationStrategy(SessionEnhanceCheckService sessionEnhanceCheckService, SessionRegistry sessionRegistry, BrowserProperties browserProperties) {
    ...
    public void onAuthentication(Authentication authentication,
        ...
        // concurrent control
        if (browserProperties.getSession().getSessionNumberControl())
        {
