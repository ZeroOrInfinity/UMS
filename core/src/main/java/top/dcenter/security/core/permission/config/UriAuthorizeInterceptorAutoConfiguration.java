...
import top.dcenter.security.core.config.PropertiesAutoConfiguration;
...
/**
 * 使用 注释({@link top.dcenter.security.core.permission.annotation.UriAuthorize} 和 {@link org.springframework.security.access.prepost.PreAuthorize}) 的方式进行 uri 访问权限控制,
