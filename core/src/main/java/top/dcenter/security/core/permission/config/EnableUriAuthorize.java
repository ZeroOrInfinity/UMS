...
/**
 * 启用访问权限控制. <br><br>
 * 1. 拦截器模式, 在方法上注释 {@link top.dcenter.security.core.permission.annotation.UriAuthorize} 或 {@link org.springframework.security.access.prepost.PreAuthorize} 方式进行 uri 权限控制.<br>
...
public @interface EnableUriAuthorize {
     ...
     * 拦截器模式, 在方法上注释 {@link top.dcenter.security.core.permission.annotation.UriAuthorize} 或 {@link org.springframework.security.access.prepost.PreAuthorize} 方式进行 uri 权限控制
     * @return
     */
