package top.dcenter.security.core.api.rememberme.repository;
 ...
 * {@link top.dcenter.security.core.auth.rememberme.repository.JdbcTokenRepositoryFactory}, 如需持久化到 redis, 则实现此接口并注入
