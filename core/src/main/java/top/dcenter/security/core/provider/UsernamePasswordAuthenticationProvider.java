package top.dcenter.security.core.provider;
...
public class UsernamePasswordAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public UsernamePasswordAuthenticationProvider(PasswordEncoder passwordEncoder, AbstractUserDetailsService abstractUserDetailsService) {
