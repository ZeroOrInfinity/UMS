...
import top.dcenter.security.social.gitee.adapter.AbstractOAuth2ApiBinding;
import top.dcenter.security.social.gitee.adapter.GiteeTokenStrategy;
...
public class GiteeImpl extends AbstractOAuth2ApiBinding implements Gitee {
    ...
    public GiteeUserInfo getUserInfo() throws IOException {
        ...
        {
            log.debug("gitee userInfo = {}", callback);
        }
        GiteeUserInfo giteeUserInfo = objectMapper.readValue(callback, GiteeUserInfo.class);
