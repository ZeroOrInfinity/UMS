...
public class OAuthJdbcUsersConnectionRepository implements UsersConnectionRepository {
    ...
    @Cacheable(cacheNames = RedisCacheAutoConfig.USER_CONNECTION_HASH_ALL_CLEAR_CACHE_NAME, key = "#connection.key.providerId + '__' + #connection.key" +
    ...
    @Cacheable(cacheNames = RedisCacheAutoConfig.USER_CONNECTION_HASH_ALL_CLEAR_CACHE_NAME, key = "#providerId + '__' + #providerUserIds",
