...
public class RemoveConnectionsByConnectionKeyWithProviderUserIdKeyGenerator extends BaseKeyGenerator {
    ...
    public Object generate(Object target, Method method, Object... params) {
        ...
        ConnectionKey key = (ConnectionKey) params[0];
        return sb.append(key.getProviderId() + RedisCacheAutoConfig.REDIS_CACHE_HASH_KEY_SEPARATE + key.getProviderUserId()).toString();
    }
}
