...
import top.dcenter.security.core.config.SmsCodeAuthenticationConfigurerAware;
import top.dcenter.security.core.config.ValidateCodeConfigurerAware;
...
public class BrowserSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    public BrowserSecurityConfigurer(BrowserProperties browserProperties,
